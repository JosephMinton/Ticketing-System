...
## Scenario 1: Password Reset and Request
...
> 📸 [SCREENSHOT PLACEHOLDER — Zendesk agent ticket view showing ticket status, SLA timer, and macro dropdown]
...
> 📸 [SCREENSHOT PLACEHOLDER — Freshservice incident ticket showing Activity Log, SLA widget, and resolution note field]
...
> 📸 [SCREENSHOT PLACEHOLDER — ServiceNow Incident form showing CI field, OLA timer, assignment group, and workflow state]
...
> 📸 [SCREENSHOT PLACEHOLDER — JSM issue view showing SLA countdown timer, internal comment vs. customer reply toggle, and request type]

-----

## Scenario 2 — New Employee Onboarding / Offboarding Request
...
> 📸 [SCREENSHOT PLACEHOLDER — Zendesk ticket form for new hire request showing custom fields and side conversation panel]
...
> 📸 [SCREENSHOT PLACEHOLDER — Freshservice Service Catalog onboarding request showing auto-generated child tasks and asset assignment panel]
...
> 📸 [SCREENSHOT PLACEHOLDER — ServiceNow Flow Designer view showing onboarding workflow stages and conditional routing logic]
...
> 📸 [SCREENSHOT PLACEHOLDER — JSM automation rule configuration for onboarding ticket routing and due date assignment]
...
Working across these five platforms reinforced that the *fundamentals don’t change*. Every platform is ultimately moving a ticket from Open → In Progress → Resolved while practicing SLA. What differs is how workflows are automated, how assets are tracked, how documentation is enforced, and how deeply the tool integrates with the broader IT ecosystem.
